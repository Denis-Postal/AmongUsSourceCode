...
namespace ExitGames.Client.Photon
{
    ...
    public static class PhotonWebSocketDebug
    {
    ...
    public class SocketWebTcp : IPhotonSocket, IDisposable
    {
        ...
        public override bool Connect()
        {
                ...
                this.sock.DebugReturn = (DebugLevel l, string s) =>
                                        {
                                            if (this.State != PhotonSocketState.Disconnected)
                                            {
                                                ...
                                                {
                                                    PhotonWebSocketDebug.SetLastError(this.State + " " + s);
                                                }
            ...
            {
                PhotonWebSocketDebug.SetLastError("Connect exception: " + e.Message);
        ...
        private void ErrorCallback(int code, string message)
        {
            ...
            if (this.State != PhotonSocketState.Disconnecting && this.State != PhotonSocketState.Disconnected)
            {
                PhotonWebSocketDebug.SetLastError("Error " + code + ": " + message);
