...
public class PlayerVoteArea : MonoBehaviour
{
	...
	public IEnumerator CoAnimateOverlay()
	{
		...
		if (isDead)
		{
			...
			{
				Overlay.color = Color.Lerp(Palette.ClearWhite, Color.white, t / fadeDuration);
				yield return null;
			}
	...
	{
		return (sbyte)((state & 0xF) - 1);
	}

	public byte GetState()
	{
		return (byte)(((votedFor + 1) & 0xF) | (isDead ? 128 : 0) | (didVote ? 64 : 0) | (didReport ? 32 : 0));
	}
}
